...
- Name: home.spec.ts >> Home Page >> should display footer
- Location: e2e/home.spec.ts:44:3
...
Locator: locator('footer').locator('a[href="/"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('footer').locator('a[href="/"]')
