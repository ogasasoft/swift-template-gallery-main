    ...
    <section id="pricing" aria-labelledby="pricing-heading" className="py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Basic plan includes template usage and content replacement. Additional options available
          upon request.
        </p>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-8">
            <p className="text-muted-foreground mb-6">
              <span className="font-semibold text-foreground">Delivery time:</span> Usually within
              5–7 business days after receiving materials.
            </p>
