...
describe('GalleryFilters Component', () => {
  ...
  it('should call setFilters when search changes', () => {
    ...
    expect(setFilters).toHaveBeenCalledWith(expect.objectContaining({ search: 'cafe' }));
  });

  it('should show clear button when search is active', () => {
    render(<GalleryFilters {...defaultProps} filters={{ ...defaultFilters, search: 'test' }} />);
  ...
  it('should remove industry filter chip when clicked', () => {
    ...
    expect(setFilters).toHaveBeenCalledWith(expect.objectContaining({ industry: ['Restaurant'] }));
  });

  it("should show 'selected' label when active filters exist", () => {
    render(<GalleryFilters {...defaultProps} filters={{ ...defaultFilters, tags: ['Cafe'] }} />);
