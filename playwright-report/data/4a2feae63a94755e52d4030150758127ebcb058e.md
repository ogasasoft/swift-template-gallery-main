...
- Name: navigation.spec.ts >> Navigation >> should have hero section
- Location: e2e/navigation.spec.ts:38:3
...
Locator: locator('section[id="hero"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('section[id="hero"]')
