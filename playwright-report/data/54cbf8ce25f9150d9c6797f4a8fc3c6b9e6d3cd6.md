...
- Name: home.spec.ts >> Home Page >> should have social links in footer
- Location: e2e/home.spec.ts:50:3
...
Locator: locator('footer').locator('a[href*="github"], a[href*="twitter"], a[href*="discord"]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('footer').locator('a[href*="github"], a[href*="twitter"], a[href*="discord"]').first()
