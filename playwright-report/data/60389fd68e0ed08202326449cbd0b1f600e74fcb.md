...
- Name: home.spec.ts >> Home Page >> should display the hero section
- Location: e2e/home.spec.ts:8:3
...
Error: strict mode violation: locator('h1') resolved to 2 elements:
    1) <h1 class="text-5xl md:text-6xl font-bold text-foreground mb-6">See it. Choose it. Get it fast.</h1> aka getByRole('heading', { name: 'See it. Choose it. Get it' })
    2) <h1 class="text-4xl font-bold mb-4">Template Gallery</h1> aka getByRole('heading', { name: 'Template Gallery' })
