...
- Name: template-gallery.spec.ts >> Template Gallery >> should display template cards with correct structure
- Location: e2e/template-gallery.spec.ts:37:3
...
Locator: locator('[data-testid="template-card"]').first().locator('img')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="template-card"]').first().locator('img')
